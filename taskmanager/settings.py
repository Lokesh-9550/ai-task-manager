"""
Django settings for the AI Task Manager project.
"""
import os
...
# Database
# Defaults to SQLite for zero-setup local dev. Set env vars to use MySQL,
# matching the architecture described on the resume:
